...
When contributing UI/UX changes, please keep these principles in mind. The `docs/settings-uiux-suprema-plan.md` file contains the original vision and criteria if you want deeper context.
