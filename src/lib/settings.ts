...
export const RECOMMENDED_LLM_MODELS = [
  { id: "Llama-3.2-1B-Instruct-Q4_0", label: "Llama 3.2 1B Instruct (Q4_0, ultra-light ~0.5-1GB, fast)" },
  { id: "Qwen3-1.7B-Q4_0", label: "Qwen3 1.7B Instruct (Q4_0, excellent instruction following)" },
  { id: "Qwen3-4B-Q4_K_M", label: "Qwen3 4B Instruct (Q4_K_M, strong quality still lightweight)" },
] as const;

export const DEFAULT_LLM_MODEL = RECOMMENDED_LLM_MODELS[0].id; // Primary: Llama 3.2 1B
export const DEFAULT_EMBED_MODEL = "embeddinggemma-300m-Q4_0";
